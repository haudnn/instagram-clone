          ...
          <div className="p-0 w-full">
            ...
            <div className="px-[12px] border-t border-gray-200 flex shrink-0 text-sm justify-center py-1">
                <form action="POST" className="flex items-center flex-row border-0 grow shrink relative align-baseline m-0 p-0 text-[100%]">
                  ...
                  <button disabled={true} className="opacity-90 relative inline-block p-0 text-blue-300 border-0 bg-none cursor-pointer box-border text-sm font-semibold w-auto text-ellipsis text-center select-none"></button>
                </form>
            </div>
          </div>
        </div>
