  ...
  return (
    <section className="h-40 space-y-0.5 md:space-y-2">
      <div className="relative group md:-ml-2">
        <IoIosArrowBack className={`absolute top-0 bottom-0 left-2 z-40 m-auto h-6 w-6 cursor-pointer opacity-0 transition group-hover:opacity-100 ${!isMoved && "hidden"}  text-white`}
