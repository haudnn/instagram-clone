                                                                            ...
                                                                            <div className="flex flex-0-auto flex-row justify-start items-center">
                                                                                ...
                                                                                <div className="flex flex-auto min-h-0 min-w-0 justify-center flex-col items-stretch">
                                                                                    <div className="container-flex-0-auto-start">
                                                                                        <div className="block overflow-hidden text-ellipsis whitespace-nowrap font-normal text-neutral-800 text-sm mt-[-3px] mb-[-4px]">
                                                                                            <div className="font-normal text-neutral-800 text-sm mt-[-3px] mb-[-4px]">ngoc.hauu19</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
