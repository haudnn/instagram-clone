...
const CreatePost = ({ isCreate }: Props) => {
    return (
        isCreate && <>
            <Head>
                    ...
                    <div className="flex items-center justify-center w-full h-full grow shrink-0">
                        <div className="min-h-0 min-w-0 flex justify-center box-border items-start">
                            <div className="flex justify-center flex-col items-center relative overflow-y-hidden box-content outline-none">
                                <div className="flex shrink justify-center m-5 relative ccontainer-modal-base">
                                                                    ...
                                                                    <div className=" flex flex-auto items-stretch border-0 box-border flex-col m-0 p-0 relative align-baseline overflow-x-hidden overflow-y-auto">
                                                                        ...
                                                                        <div className="container-flex-0-auto-start">
                                                                            ...
                                                                            <div className="flex justify-between items-stretch border-0 box-border flex-row shrink-0 m-0 p-0 relative align-baseline">
                                                                                <div className="flex py-1 px-2 flex-auto min-h-0 min-w-0 justify-start flex-col items-start">
                                                                                    <button className="p-2 flex items-center justify-center border-none cursor-pointer">
                                                                                        <div className="flex items-center justify-center">
                                                                                            <FaRegSmile className="w-5 h-5 text-[rgb(142,142,142)]"></FaRegSmile>
                                                                                        </div>
                                                                                    </button>
                                                                                </div>
                                                                                <div className="flex-initial flex flex-col justify-center items-stretch">
                                                                                    <div className="cursor-pointer flex tabular-nums lining-nums justify-center px-4 text-right select-none">
                                                                                        <div className="block text-[rgb(199,199,199)] font-normal text-xs mt-[-2px] mb-[-3px]">
                                                                                            <span>0</span>
                                                                                            /{""}
                                                                                            <span>2,200</span>
                                                                                        </div>
                                                                            ...
                                                                            <div className="absolute top-[100%] w-full bg-white box-shadow-create" ></div>
                                                                        </div>
                                                                        <div>
                                                                            <div className="flex px-2 justify-center border-t border-solid border-t-[rgb(219,219,219)]">
                                                                                <label className="h-[44px] bg-transparent border-none text-base flex items-center grow justify-between pr-2 relative outline-none text-neutral-800 fill-neutral-800">
                                                                                    <input placeholder="Add location" autoComplete="off" type="text" className="w-full py-1 px-[9px] border-none text-base text-neutral-800 fill-neutral-800 grow m-0 overflow-visible outline-none" />
                                                                                    <div className="container-flex-0-auto-start ml-2">
                                                                                        <GoLocation className="w-4 h-4 text-neutral-800"></GoLocation>
                                                                                    </div>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div className="flex justify-center border-t border-solid border-t-[rgb(219,219,219)]">
                                                                            <div className="w-full cursor-pointer flex justify-between align-center flex-row px-4 py-[14px] select-none">
                                                                                <div className="block text-neutral-800 text-base font-normal my-[-6px]">Advanced settings</div>
                                                                                <IoIosArrowDown className="w-4 h-4 inline-block text-neutral-800"></IoIosArrowDown>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
