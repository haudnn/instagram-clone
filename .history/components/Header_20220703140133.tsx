            ...
            <div className="border-b border-solid p-3 shadow-sm" >
                <div className="max-w-screen-lg flex items-center justify-between m-auto box-border ">
                    ...
                    <div className="hidden items-center bg-slate-100 rounded-md relative h-[36px] py-4 sm:flex mx-2 w-[268px]">
                        ...
                        <div className="relative top-8 w-[375px] left-[-268px] after:content-[''] after:position-[absolute] after:border-solid  after:border-x-[10px]  after:border-y-[17px]  after:border-t-transparent after:block  after:border-l-transparent  after:border-r-transparent  after:border-b-neutral-700 ">
