                                                                ...
                                                                <div className="flex items-start flex-row justify-between">
                                                                    <div className="w-full flex flex-row">
                                                                        <div className="block w-fit h-fit relative">
                                                                            <div className="w-[32px] h-[32px] conic-gradient relative rounded-full m-r-[18px] cursor-pointer">
                                                                                <img
                                                                                    src="https://picsum.photos/id/237/300/300"
                                                                                    className="absolute rounded-full md:rounded-full w-full h-full p-[2px] top-[-5px] left-[-5px]"
                                                                                    alt=""
                                                                                />
                                                                            </div>
                                                                        </div>
