                                                    ...
                                                    <div className="w-full h-full flex items-center justify-center">
                                                        <div className="w-full h-full p-[24px] flex flex-0-auto justify-center flex-col items-center">
                                                            ...
                                                            <div className="flex flex-0-auto justify-start flex-row items-center mt-6">
                                                                <label id="File-Lable" className="flex flex-0-auto justify-start flex-col items-strech p-1" htmlFor="File-For">
                                                                    <button id="Filebutton" className="button-add-pic">Select from computer</button>
                                                                </label>
