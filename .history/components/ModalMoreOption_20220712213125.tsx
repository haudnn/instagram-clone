              ...
              <div className="w-[400px] flex shrink justify-center m-5 relative container-modal-base">
                <div style={{ maxHeight: "calc(100vh - 40px)" }} className="w-full bg-white overflow-y-auto overflow-x-auto rounded-r-xl rounded-l-xl ">
                  <div className="flex flex-col h-full max-w-full">
                    <div className="flex items-stretch border-0 box-border flex-col shrink-0 w-full h-full justify-center m-0 p-0 relative align-baseline">
                      {/* <div className="flex items-stretch border-0 box-border flex-col shrink-0 justify-center m-0 p-0 relative align-baseline">
                        <button className="button-more-options warning text-sm">
                          Report
                        </button>
                        <button className="button-more-options warning text-sm">
                          Unfollow
                        </button>
                        <button className="button-more-options text-sm">
                          Go to post
                        </button>
                        <button className="button-more-options text-sm">
                          Share to...
