        ...
        <header className="fixed top-0 left-0 right-0">
            <div className="border-b border-solid p-3 drop-shadow" >
                <div className="max-w-screen-lg flex items-center justify-between m-auto box-border ">
                    ...
                    <div className="hidden items-center bg-slate-100 rounded-md relative h-[36px] py-4 sm:flex mx-2 " >
                        <div className="">
                            <input type="text" placeholder="Search" className=" relative bg-slate-100 outline-none pl-10 w-[268px]  "/>
                            <div className="absolute left-3 inline-block" >
                                <BiSearch></BiSearch>
                            </div>
                        </div> 
                        <div className="relative top-8 w-[375px] left-[-268px] ">
                            <div className="absolute h-10 w-8  bg-white rotate-45 left-[170px] top-[-6px] drop-shadow"></div>
                            <div className="absolute bg-white drop-shadow rounded-md p-4">
