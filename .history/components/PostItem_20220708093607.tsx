    ...
    <div>
      ...
      <div className="mb-2 px-[12px] flex flex-row justify-end">
          <div className="flex justify-start flex-row items-stretch flex-auto min-h-0 min-w-0">
            <div className='flex flex-auto justify-start flex-col items-start mr-1'>
            ...
            <div className="flex flex-wrap flex-auto min-h-0 min-w-0 justify-start items-stretch ">
