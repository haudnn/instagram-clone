                                ...
                                <div className="flex flex-col grow shrink-[2] max-w-[500px] m-w-[405px]">
                                    <div className="flex justify-start flex-row items-stretch flex-auto min-h-0 min-w-0 ">
                                        <div className="rounded-r bg-white h-full w-full">
                                            ...
                                            <div className="p-0 border-l border-solid border-l-gray-600 w-full min-w-[335px] box-border relative flex grow flex-col shrink-0 items-stretch">
                                                <section className="px-4 mt-1 flex flex-row pb-2 pt-[6px] m-0 order-3 border-l border-solid border-l-gray-600">
                                                ...
                                                <div className="p-0 my-0 mr-0 mb-auto order-1 overflow-x-hidden overflow-auto relative flex-col box-border items-stretch flex grow shrink min-h-0">
                                                            ...
                                                            <li className="pb-4 pt-[5px] pr-4 w-auto overflow-visible relative mr-[-2px] mt-[-5px] break-words">
                                                                <div className="flex items-start flex-row justify-between">
                                                                    <div className="w-full flex flex-row">
                                                                        <div className="block w-fit h-fit relative">
                                                                            <div className="cursor-pointer relative m-r-[18px]">
                                                                                <div className="w-[42px] h-[42px] top-[-5px] left-[-5px] conic-gradient absolute rounded-full mb-3">
                                                                                    <img
