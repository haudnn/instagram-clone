  ...
  return (
    <section className="h-40 space-y-0.5 md:space-y-2">
      <div className="relative group md:-ml-2">
        <div className="h-6 w-6 absolute top-0 bottom-0 left-2 z-40 m-auto bg-white rounded-full p-2 flex items-center">
          <IoIosArrowBack className={`h-full w-full cursor-pointer opacity-0 transition group-hover:opacity-100 ${!isMoved && "hidden"}text-black`}
