  ...
  return (
    <section className="h-40 space-y-0.5 md:space-y-2">
      <div className="relative group md:-ml-2">
        <div className="absolute top-0 bottom-0 left-2 z-40  bg-white rounded-full p-2 cursor-pointer">
          <IoIosArrowBack className={`h-5 w-5 m-auto ${!isMoved && "hidden"}text-black`}
