                                                ...
                                                <div className="w-full h-full">
                                                    <div className="flex overflow-x-auto overflow-y-hidden h-full flex-row"   >
                                                        ...
                                                        <button className="right-0 cursor-pointer bg-transparent border-none justify-self-center outline-none px-2 py-4 absolute top-[50%] translate-y-[-50%]">
                                                            <div className="w-8 h-8 bg-no-repeat  bg-[url('https://static.cdninstagram.com/rsrc.php/v3/y5/r/bve3a0HeZc8.png')]"></div>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                                                        ...
                                                                        <div className="inline-block shrink min-w-0">
                                                                            <h2 className="inline-flex items-center">
                                                                                ...
                                                                                <div className="flex flex-0-auto justify-start flex-col items-stretch">
                                                                                    <span className="shrink-0 w-3 h-3 bg-no-repeat bg-x bg-[url('https://static.cdninstagram.com/rsrc.php/v3/y5/r/bve3a0HeZc8.png')]"></span>
                                                                                </div>
                                                                            </h2>
                                                                        </div>
                                                                    </div>
