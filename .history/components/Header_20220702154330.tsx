                ...
                <div className="max-w-screen-lg flex items-center justify-between m-auto box-border ">
                    ...
                    <nav >
                        <ul className="flex items-center justify-between gap-x-6 flex-row whitespace-nowrap">
                            <li>
                                <a>
                                    <MdHomeFilled className="h-7 w-7"></MdHomeFilled>
                                </a>
                            </li>
                            <li>
                                <a>
                                    <TbLocation className="h-7 w-7"></TbLocation>
                                </a>
                            </li>
                            <li>
                                <a>
                                    <MdAddCircleOutline className="h-7 w-7"></MdAddCircleOutline>
                                </a>
                            </li>
                            <li>
                                <a>
                            ...
                            <li>
                                <a>
                                    <FaRegHeart className="h-7 w-7"></FaRegHeart>
                                </a>
                            </li>
                            <li>
                                <div>
