                                ...
                                <div className="flex flex-col grow shrink-[2] max-w-[500px] m-w-[405px]">
                                    <div className="flex justify-start flex-row items-stretch flex-auto min-h-0 min-w-0 ">
                                        <div className="rounded-r bg-white h-full w-full">
                                            ...
                                            <div className="p-0 border-l border-solid border-l-gray-600 w-full min-w-[335px]">
                                                ...
                                                <div className="p-0 mx-0 mt-0 mb-auto order-1 overflow-x-auto flex grow shrink min-h-0">
                                                                ...
                                                                <div className="flex items-start flex-row justify-between">
                                                                    <div className="w-full flex flex-row">
                                                                        <div className="block w-fit h-fit relative">
                                                                            <div className="w-[32px] h-[32px] conic-gradient cursor-pointer relative m-r-[18px] rounded-full mb-3">
                                                                                <img
                                                                                    src="https://picsum.photos/id/237/300/300"
                                                                                    className="absolute top-[-5px] left-[-5px] rounded-full md:rounded-full w-full h-full p-[2px]"
                                                                                    alt=""
                                                                                />
                                                                            </div>
                                                                        </div>
