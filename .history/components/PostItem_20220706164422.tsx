                  ...
                  <div className="flex flex-auto justify-end flex-row items-center ">
                    <div className="w-5 h-5 order-2 cursor-pointer border-2 border-white rounded-[50%] box-content">
                      <span className="w-5 h-5 bg-zinc-50 rounded-[50%] box-border block  overflow-hidden flex-auto relative">
                        <img src="https://instagram.fdad2-1.fna.fbcdn.net/v/t51.2885-19/276006630_269868105324314_3262122051765109407_n.jpg?stp=dst-jpg_s150x150&_nc_ht=instagram.fdad2-1.fna.fbcdn.net&_nc_cat=1&_nc_ohc=gZU_yN9Mm3cAX9_j3G4&edm=ABmJApABAAAA&ccb=7-5&oh=00_AT_yRVimfB_NHgoQ4OB64U8NqjkDp8OQaSAecdXwExoz-Q&oe=62CC0A2D&_nc_sid=6136e7" alt="" />
                      </span>
