...
const PostItem = () => {
  return (
    <div>
        ...
        <div className="flex flex-row h-full0">
          <ul>
            <li>
              <div className='w-full flex flex-auto justify-start flex-col items-stretch'>
                <div>
                  <div>
                    <div className='pb-[105.556%] block overflow-hidden relative'>
                      <img src="https://unsplash.com/photos/d2w-_1LJioQ" alt="" className='absolute h-full left-0 top-0 w-full object-cover'/>
                    </div>
