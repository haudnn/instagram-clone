  ...
  return (
    <section className="h-40 space-y-0.5 md:space-y-2">
      <div className="relative group md:-ml-2">
        ...
        <IoIosArrowForward className="bg-white absolute top-0 bottom-0 right-2 z-40 m-auto h-5 w-5  rounded-full  p-2  cursor-pointer opacity-0 transition group-hover:opacity-100"
