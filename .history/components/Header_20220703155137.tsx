        ...
        <header className="fixed top-0 left-0 right-0">
            <div className="border-b border-solid p-3 drop-shadow" >
                <div className="max-w-screen-lg flex items-center justify-between m-auto box-border ">
                    ...
                    <div className="hidden items-center bg-slate-100 rounded-md relative h-[36px] py-4 sm:flex mx-2 w-[268px]" onClick={() => setIsSearch(true)}>
                        <div className="relative flex items-center">
                            <input type="text" placeholder="Search" className=" bg-slate-100 outline-none pl-10 w-[268px]  "/>
                            <div className="absolute left-3" >
                                <BiSearch></BiSearch>
                            </div>
                            <div className={`${isSearch ? "" : "hidden"} absolute right-3 cursor-pointer`}>
                                <IoIosCloseCircleOutline className="h-5 w-5 "onClick={() => setIsSearch(false)} ></IoIosCloseCircleOutline>
                            </div>
                        </div> 
                        {isSearch && (
