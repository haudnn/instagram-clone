                                    ...
                                    <div className="flex items-center justify-between w-full mt-3">   
                                        <div className="flex items-center gap-x-4">
                                            ...
                                            <div className="flex flex-col">
                                                <p className="font-medium text-sm">virusinmyeyes</p>
                                                <p className="text-sm text-slate-500">Crybaby</p>
                                            </div>
                                        </div>
                                        <div>
                                            <AiOutlineClose className="h-5 w-5 text-slate-500"></AiOutlineClose>
                                        </div>
                                    </div>
                                </div>
