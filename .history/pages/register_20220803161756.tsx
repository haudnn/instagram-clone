...
import { authActions, selectMessageERR } from '../features/auth/authSlice';
                                ...
                                <div className="box-border flex flex-col items-stretch mb-5 shrink-0">
                                    <form onSubmit={onSubmit} className="max-w-[350px] flex flex-col"  >
                                        ...
                                        <div className="m-2 mx-10 container-flex-0-auto-start" >
                                            <button type="submit" className="cursor-pointer rounded relative flex items-center justify-content text-[14px] font-semibold text-center w-auto select-none text-ellipsis py-[5px] px-[9px] bg-[rgba(0,149,246,1)] text-[rgba(255,255,255,1)]">
                                                <div className="container-flex-0-auto-start">Sign up</div>
                                                <div role="status">
                                                    <svg aria-hidden="true" className="mr-2 w-2 h-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
