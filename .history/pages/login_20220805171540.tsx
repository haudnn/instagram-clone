...
const login = () => {
  ...
  const refreshToken = () => {
    setCookie('refresh_token', 'refresh_token', { expires: 7, path: '' })
  ...
  const isLoggedIn2 = getCookie('access_token')
  console.log("Res" + isLoggedIn)
  console.log("ACC" + isLoggedIn2)
  return (
    <div>
      <Head>
        ...
        <main className="bg-[rgba(250,250,250,1)] flex grow order-4 m-0 p-0 relative shrink-0 items-stretch box-boder flex-col">
          <article className="flex flex-row justify-center items-center mx-auto mt-8 mb-0 max-w-[935px] pb-8 w-full">
            ...
            <div className="mt-3 w-full max-w-[350px] text-[rgba(38,38,38,0.1)]">
              ...
              <div className="m-2 mx-10 container-flex-0-auto-start" >
                <button onClick={setToken} className="cursor-pointer rounded relative block text-[14px] font-semibold text-center w-auto select-none text-ellipsis py-[5px] px-[9px]
                    bg-[rgba(0,149,246,1)] text-[rgba(255,255,255,1)]">
                  <div className="container-flex-0-auto-start">Get Token</div>
                </button>
              </div>

              <div className="m-2 mx-10 container-flex-0-auto-start" >
                <button  onClick={refreshToken} className="cursor-pointer rounded relative block text-[14px] font-semibold text-center w-auto select-none text-ellipsis py-[5px] px-[9px]
                    bg-[rgba(0,149,246,1)] text-[rgba(255,255,255,1)]">
                  <div className="container-flex-0-auto-start">RES Token</div>
                </button>
              </div>

              <div className="m-2 mx-10 container-flex-0-auto-start" >
                <button  onClick={removeToken} className="cursor-pointer rounded relative block text-[14px] font-semibold text-center w-auto select-none text-ellipsis py-[5px] px-[9px]
                    bg-[rgba(0,149,246,1)] text-[rgba(255,255,255,1)]">
                  <div className="container-flex-0-auto-start">REMOVE Token</div>
                </button>
              </div>
