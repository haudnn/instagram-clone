                ...
                <div className="mb-[10px] max-w-[350px] w-full flex flex-col shrink-0 m-0 p-0 box-border relative items-stretch">
                    <form method="post" action="" className="flex flex-col">
                      <div className="mt-6 container-flex-0-auto-start">
                        ...
                        <div className="m-2 mx-10 container-flex-0-auto-start">
                          <button type="submit" className="inline-block border-0 text-[rgba(0,149,246,0,149,246),1)] p-0 relative cursor-pointer text-[14px] font-semibold text-center w-auto select-none text-ellipsis ">
                            <AiFillFacebook className="inline-block mr-2 relative top-[3px] w-4 h-4"></AiFillFacebook>
                          </button>
                        </div>
                      </div>
                    </form>
