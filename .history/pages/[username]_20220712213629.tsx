...
import { IoIosArrowDown,IoMdGrid,IoIosChatbubbles } from "react-icons/io"
                    ...
                    <div className="pt-[30px] px-[20px] pb-0 box-content flex flex-col shrink-0 relative container-profile mb-0 mx-auto mt-0 grow max-w-[935px]">
                        ...
                        <div className="flex flex-col shrink-0 items-stretch box-border">
                            <article className="flex grow flex-col shrink-0 items-stretch box-border">
                                <div className="flex flex-col shrink-0 items-stretch box-border">
                                    <div className="flex-col pb-[0px] pt-0">
                                        <div className="flex flex-row mb-[28px] ">
                                            {/* post */}
                                            <div className="flex-profile mr-[28px] block relative w-full">
                                                <a href="/" className="cursor-pointer group"> 
                                                    ...
                                                    <div className="flex items-end absolute inset-0 justify-start pointer-events-none flex-col">
                                                        <div className="container-flex-0-auto-start m-2">
                                                            <BiCarousel className="w-[22px] h-[22px] block relative text-white"></BiCarousel>
                                                        </div>
                                                    </div>
                                                    <div className="group-hover:flex hidden absolute inset-0 justify-center flex-col bg-[rgba(0,0,0,0.3)]">
                                                        <ul className="flex items-center justify-center w-full h-full align-baseline">
                                                            <li className="inline-flex flex-row-reverse mr-[30px] p-0 align-baseline items-center">
                                                                <div className="block text-white font-semibold text-base">
                                                                    <span>19.5K</span>
                                                                </div>
                                                                <AiFillHeart className='text-white text-base mr-[5px]'></AiFillHeart>
                                                            </li>
                                                            <li className="inline-flex flex-row-reverse mr-[30px] p-0 align-baseline items-center">
                                                                <div className="block text-white font-semibold text-base">
                                                                    <span>52</span>
                                                                </div>
                                                                <IoIosChatbubbles className='text-white text-base mr-[5px]'></IoIosChatbubbles>
                                                            </li>
                                                        </ul>
                                                    </div> 
                                                </a>                                                
                                            ...
                                            <div className="flex-profile  block relative w-full">
                                                <a href="/" className="cursor-pointer group"> 
                                                    <div className="bg-[rgb(239,239,239)] w-full">
                                                        <div className="overflow-hidden pb-[100%] relative">
                                                            <img src="https://source.unsplash.com/random" alt="" className="object-cover h-full absolute left-0 top-0 select-none w-full" />
